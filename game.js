...
function draw() {
    ...
    if(dynamicCloudSprite2.x > 2100) dynamicCloudSprite2 = -900;
...
function cloudSetUp(){
    ...
    dynamicCloudSprite = new Sprite(dynamicCloud, 600, 520, 50, 50);
    ...
    dynamicCloudSprite2 = new Sprite(dynamicCloud, -1500, 520, 50, 50);
