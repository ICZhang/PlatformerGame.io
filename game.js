...
function draw() {
    ...
    fill("green");
    dynamicCloudSprite.x+=2;
    dynamicCloudSprite2.x+=2;
    ...
    text("W: " + dynamicCloudSprite.width, 200, 100);
